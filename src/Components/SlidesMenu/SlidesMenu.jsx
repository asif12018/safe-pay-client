     ...
     <>
       {
		...
		<button onClick={handleHide}><GiHamburgerMenu /></button>
		</div>
	   }
		{
			isOpen &&  <div className="h-full md:h-screen bg-gradient-to-r from-indigo-400 to-cyan-400 animate-fade-right">
			<div className="flex flex-col h-full p-3 w-60   ">
		<div className="space-y-3 ">
			<div className="flex items-center justify-between">
				<h2>Dashboard</h2>
				<button onClick={()=>handleHide()} className="p-2">
			...
			<div className="flex-1">
				<ul className="pt-2 pb-4 space-y-1 text-sm">
					<li className="rounded-sm">
						<Link to={'/register'} rel="noopener noreferrer"  className="flex items-center p-2 space-x-3 rounded-md">
							<span>
							<FaUserEdit />
							</span>
					...
					<li className="rounded-sm">
						<Link to={'/login'} rel="noopener noreferrer"  className="flex items-center p-2 space-x-3 rounded-md">
							<span>
							<MdVerifiedUser />
							</span>
							<span>Login</span>
